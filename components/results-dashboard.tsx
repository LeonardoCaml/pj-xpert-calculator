...
export function ResultsDashboard({
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border border-primary/20 p-5 sm:p-8">
        ...
        <div className="relative">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-4xl font-extrabold tracking-tighter text-success sm:text-6xl lg:text-7xl">
              <NumberTicker
                value={result.hourlyRate}
                formatFn={formatCurrency}
              />
            </span>
            <span className="text-base sm:text-xl text-muted-foreground">/hora</span>
          </div>
          
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <div className="flex w-full items-center gap-2 rounded-full bg-surface/60 px-4 py-2 sm:w-auto">
